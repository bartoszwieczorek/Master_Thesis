...
for topic in topics:
    ...
    samples_creative.append((creative['likeCount']/creative['viewCount']).fillna(0).values)
    samples_youtube.append(youtube['likeCount']/youtube['viewCount'].fillna(0).values)
    ...
    plt.legend()
    plt.title(topic)
    plt.xlabel('Prawdopodobieństwo polubienia po wyświetleniu')
    plt.ylabel('Prawdopodobieństwo')
    tikzplotlib.save(f'latex_empirical_dist/{topic}.tex', encoding='utf-8')
