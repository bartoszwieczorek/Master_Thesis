...
MoviesStats1 = MoviesStats(API_KEY, 'short', 'rating', '/m/02vx4', 'youtube', COUNTRY)
...
MoviesStats1.get_comment_stats()
MoviesStats1.get_comment_results()
